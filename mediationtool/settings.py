"""
Django settings for mediationtool project.
...
SECRET_KEY = 'bw4*4h*_*8+esblv7kfo34o5-3*%qnpekesr&5xxz8nr#9v(xg'
...
ROOT_URLCONF = 'mediationtool.urls'
...
WSGI_APPLICATION = 'mediationtool.wsgi.application'
